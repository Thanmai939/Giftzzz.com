    ...
    <style>
      :root
        ...
        *
        ...
        .hero 
        {
          background-image: url(sellnowloquote.jpg);
  ...
  <header class="first">
    <!--header section starts-->
        ...
        <div class="icons">
            ...
            <a href="./cartdisplay.php" class="fas fa-shopping-cart"></a>&nbsp; &nbsp;
  ...
  <section class="hero">
    ...
    <section class="featured-products">
      <div class="product-grid">
        ...
        $query = 'SELECT itemname,itemimage,itemprice
            FROM sellnow
            ORDER BY itemname';
        ...
        {  
          ...
          echo '<img src="'.$record['itemimage'].'" >';
          echo '<h3>'.$record['itemname'].'</h3>';
          echo '<p class="price"><span class="WebRupee">Rs.</span>'.$record['itemprice'].'</p>';
          echo '
        
                <form action="" method="POST" class="box">
                        <input type="hidden" name="p_name" class="nm" value="'.$record['itemname'].'">
                        <input type="hidden" name="p_price" value="'. $record['itemprice'].'">
                        <input type="hidden" name="p_image" value="'. $record['itemname'].'">
