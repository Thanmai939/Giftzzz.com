  ...
  <header class="first">
    <!--header section starts-->
        ...
        <a href="./afterlogin.html" class="fas fa-home"></a>
            ...
            <a href="./cartdisplay.php" class="fas fa-shopping-cart">&nbsp; &nbsp;
    ...
    <section class="featured-products">
      <div class="product-grid">
        ...
        {  
          ...
          echo '<img src="comboimages/'.$record['filename'].'" >';
          ...
          echo '
                ...
                <form action="" method="POST" class="box">
                        ...
                        <input type="hidden" name="p_image" value="comboimages/'. $record['filename'].'">
