...
<html>
  ...
  <header class="first">
    <!--header section starts-->
        ...
        <div class="icons">
            ...
            <div class="myDropdown" style="display:none;">
                ...
                <a onclick="myFunction()" class="dropcolor" href="./logout.php" style="font-size: 20px;">Logout</a>
            </div>
        </div>
    <!--header section ends-->
  </header>
    ...
    <section class="hero1">
      <img src="Personalized-Gifts-Banner.jpg">
    </section>
    ...
    <section class="featured-products">
      <div class="product-grid">
        ...
        {  
          ...
          echo '<img src="personalised/'.$record['filename'].'" >';
          ...
          echo '
                <form action="" method="POST" class="box">
                        ...
                        <input type="hidden" name="p_image" value="personalised/'. $record['filename'].'">
    ...
    <footer>
      <div class="footerContainer">
          ...
          <div class="footerNav">
              <ul>
                  <li><a href="C:Abtpage.html">About Us</a></li>
